...
/**
 * The GameOptions class represents the control panel of the Game of Life application. It provides
 * controls to start and stop the simulation, to reset the board, to view the current generation
 * count, and to change the simulation delay.
 */
public final class ControlsPanel extends JPanel implements ModelObserver {
  ...
  public ControlsPanel(Model model) {
    ...
    delaySlider = new JSlider(SwingConstants.HORIZONTAL, MIN_SLIDER_POS, MAX_SLIDER_POS,
        INITIAL_SLIDER_POS);
  ...
  @Override
  public void update() {
    generationLabel.setText("Generation: %s".formatted(model.getGenerationCount()));
  }
}
